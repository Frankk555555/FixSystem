...
function AuthProvider({ children }) {
    ...
    const [currentRole, setCurrentRole] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])("user");
    ...
    const fetchUserData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "AuthProvider.useCallback[fetchUserData]": async (userId, userEmail)=>{
            try {
                // 1. Fetch profile
                const { data: profileData, error: profileErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").select("id, full_name, phone, email, person_code").eq("id", userId).maybeSingle();
                if (profileData) {
                ...
                // 2. Fetch roles
                const { data: roleRows, error: roleErr } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_roles").select("role").eq("user_id", userId);
                if (roleRows && roleRows.length > 0) {
                    const fetchedRoles = roleRows.map({
                        "AuthProvider.useCallback[fetchUserData].fetchedRoles": (r)=>r.role
                    }["AuthProvider.useCallback[fetchUserData].fetchedRoles"]);
                    setRoles(fetchedRoles);
                    // Default current role: prioritize technician or admin if available
                    const preferred = fetchedRoles.find({
                        "AuthProvider.useCallback[fetchUserData]": (r)=>r !== "user"
                    }["AuthProvider.useCallback[fetchUserData]"]) || fetchedRoles[0];
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AuthProvider.useEffect": ()=>{
            ...
            async function initAuth() {
                try {
                    const { data: { session: initSession } } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.getSession();
                    if (!mounted) return;
                    if (initSession?.user) {
    ...
    const signUp = async (data)=>{
        try {
            ...
            const { data: authData, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].auth.signUp({
            ...
            if (authData.user) {
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("profiles").upsert({
                    id: userId,
                    full_name: data.full_name.trim(),
                    phone: data.phone.trim(),
                    email: data.email.trim(),
                ...
                if (roleToAssign !== "user") {
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$integrations$2f$supabase$2f$client$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("user_roles").upsert({
                        user_id: userId,
                        role: roleToAssign
                    });
                }
...
_s(AuthProvider, "wi/8gAQVwRr6cOZAhOts8LW16fs=");
_c = AuthProvider;
function useAuth() {
    _s1();
...
function createSupabaseClient() {
    const SUPABASE_URL = ("TURBOPACK compile-time value", "https://ytvawdbegplqmmngvdqz.supabase.co") || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.SUPABASE_URL || '';
    const SUPABASE_PUBLISHABLE_KEY = ("TURBOPACK compile-time value", "sb_publishable_q6oovJ8-M_Htms-wTJFT1g_20UcVKgq") || ("TURBOPACK compile-time value", "sb_publishable_q6oovJ8-M_Htms-wTJFT1g_20UcVKgq") || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.SUPABASE_PUBLISHABLE_KEY || '';
...
//# sourceMappingURL=src_0cn23e-._.js.map